...
function Brand({ onClick }) {
  return (
    <button className="brand" onClick={() => onClick('/')} aria-label="Bayt and Brick home">
      <span className="brand-name">Bayt <em>&amp;</em> Brick</span>
